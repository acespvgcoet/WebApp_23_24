        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <p>
              ...
              undergraduates by providing them a platform to recognize their
              skill set deep insights about computational systems and related
            ...
            <p>
              ...
              towards knowledge and the society and evolve to be engaged
              community leaders.
            </p>
            <center>
              <h2>Objectives</h2>
            ...
            <ul>
              <li>
                To provide a platform for students to showcase their talents and
                skills in various domains and all perceivable fields.
              </li>
              <li>
                To provide technical as well as non – technical grooming to the
                students by organizing various workshops and activities,
                catalyzing growth.
              </li>
              <li>
                To inculcate the values of team work, leadership, management and
                soft skills.
              </li>
            </ul>
          </div>
